        ...
        <div>
            ...
            <div class="relative lg:flex justify-between items-start px-8 lg:p-16">
                ...
                <div class="relative w-full py-4 lg:p-0 lg:w-2/4">
                    <div class="lg:px-16 overflow-hidden">
                        <img src="images/intro-cover.jpg" class="rounded-xl" width="100%" height="100%">
                    </div>
                </div>
                ...
                <div class="relative w-full py-4 lg:p-0 lg:w-2/4">
                    ...
                    <div class="relative lg:px-16">
                        ...
                        <button class="accordion p-2 focus:outline-none">
                        ...
                        <button class="accordion focus:outline-none p-2">
            ...
            <div class="relative p-8 lg:px-32 text-center">
                ...
                <inertia-link href="/authenticate" class="ripple-node relative inline-block bg-pink-800 lg:mt-8 text-white rounded-md py-4 px-6 box-shadow-3xl font-bold text-xl">
                    Get started
                </inertia-link>
            </div>
